...
import { AlertCircle, Settings, Upload } from 'lucide-react';
...
export function AppSidebar({ settingsOpen, onSettingsToggle }: AppSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <Sidebar
        collapsible="none"
        className={cn('hidden flex-1', settingsOpen && 'flex')}
      >
